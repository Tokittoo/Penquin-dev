    ...
    <div className='p-8 md:px-44'>
      <div className='flex justify-between items-center gap-4 max-md:flex-col'>
        <div className='flex flex-col gap-2'>
          ...
          <p>A product by <Link className='underline hover:text-muted-foreground' href={'https://saad.works'} target={'_blank'}>Sibhi</Link></p>
        </div>
      ...
      <div className='flex justify-between items-center max-md:mt-8'>
        ...
        <div className='flex items-center gap-2'>
          ...
          <Link href={'https://t.me/'} target={'_blank'} className='p-2 rounded-full cursor-pointer'><FaTelegram size={18} /></Link>
        </div>
      </div>
    </div>
  )
